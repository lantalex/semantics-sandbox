...
abstract class PaddedAtomicLongPad {
...
class PaddedAtomicLongField extends PaddedAtomicLongPad {

    long value;

    PaddedAtomicLongField(long value) {
        this.value = value;
    }
}

//Just like regular AtomicLong with additional padding to prevent false sharing
@SuppressWarnings("unused")
public final class PaddedAtomicLong extends PaddedAtomicLongField {

    private static final VarHandle VALUE;

    static {
        try {
            VALUE = MethodHandles.lookup().findVarHandle(PaddedAtomicLongField.class, "value", long.class);
