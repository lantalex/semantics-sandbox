...
@State
public class CorrectRelaxedLazy {

    /*

        How to run:
        $ ./gradlew clean jcstress --tests  "io.github.lantalex.lazy.CorrectRelaxedLazy"
        ...
        ----------------------------------------------------------------
          RESULT     SAMPLES     FREQ      EXPECT  DESCRIPTION
              -1           0    0.00%   Forbidden  NPE is forbidden
               ...
               4  85,293,208  100.00%  Acceptable  Expected result


     */

    RelaxedLazy lazy = new RelaxedLazy(() -> new MyObject(1));
